...
@property (readonly) NSString *menuStringMiddleGesturesHeader;
@property (readonly) NSString *menuStringEnableMiddleGestures;
@property (readonly) NSString *menuStringMiddleGestureThreshold;
@property (readonly) NSString *menuStringInvertMiddleGestureY;
